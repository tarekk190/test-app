...
export const products: Product[] = [
  {
    id: 'adventure-backpack-pro',
    name: 'Adventure Backpack Pro',
    price: 129.99,
    description: 'A versatile and durable backpack perfect for all your outdoor adventures. Features multiple compartments and weather-resistant material.',
    images: [
  ...
  {
    id: 'urban-travel-duffel',
    name: 'Urban Travel Duffel',
    price: 89.99,
    description: 'Sleek and spacious duffel bag designed for urban travelers. Perfect for weekend getaways or gym sessions.',
    images: [
  ...
  },
  {
    ...
    price: 199.99,
    description: 'Premium leather weekender bag with classic design. Perfect for business trips and short vacations.',
    images: [
  ...
  },
  {
    ...
    name: 'Hiking Daypack',
    price: 79.99,
    description: 'Lightweight and comfortable daypack for hiking and outdoor activities. Features hydration compatibility.',
    images: [
  ...
  },
  {
    ...
    price: 159.99,
    description: 'Smart carry-on suitcase with smooth-rolling wheels and organized compartments. Meets airline size requirements.',
    images: [
  ...
  },
  {
    ...
    price: 69.99,
    description: 'Stylish and functional tote bag perfect for daily commute or as a personal item for flights.',
    images: [
